    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="grid md:grid-cols-3 gap-8">
            ...
            <div class="bg-gray-800 p-8 rounded-xl border border-gray-700 card-hover">
                ...
                <p class="text-gray-400">Upload your images and get a fully rendered 3D gallery in seconds. Our system automatically arranges your artwork for optimal viewing.</p>
            </div>
