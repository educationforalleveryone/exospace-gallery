...
<head>
    ...
    <title>Page Not Found — {{ config('app.name', 'Exospace') }}</title>
    <style>
...
<body>
    <main class="panel">
        ...
        <p>
            {{ __('This link may be mistyped, or the exhibition may have been unpublished, ended, or removed by its organizer.') }}
        </p>
        <div class="actions">
            <a href="{{ route('discover') }}" class="btn btn-primary">{{ __('Browse exhibitions') }}</a>
