...
@section('content')
    <div class="bg-gradient-to-br from-gray-900 via-purple-950/30 to-gray-900 border-b border-gray-800">
        <div class="max-w-7xl mx-auto px-4 py-14">
            <div class="max-w-3xl">
                <p class="text-purple-400 text-sm font-semibold tracking-widest uppercase mb-2">
    ...
    <div class="max-w-7xl mx-auto px-4 py-10">
        ...
        <nav class="mt-12 pt-8 border-t border-gray-800 flex flex-wrap gap-4 text-sm" aria-label="Discover more">
            <a href="{{ route('venues.index') }}" class="text-purple-400 hover:text-purple-300 transition">All venue templates</a>
            <a href="{{ route('discover') }}" class="text-purple-400 hover:text-purple-300 transition">Browse 3D exhibitions</a>
            <a href="{{ route('register') }}" class="text-purple-400 hover:text-purple-300 transition">Create your own exhibition</a>
        </nav>
    </div>
@endsection
