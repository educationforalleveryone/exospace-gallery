...
<section class="max-w-6xl mx-auto px-4 py-14">
    ...
    <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
        @foreach(($context['items'] ?? []) as $gallery)
            <a href="{{ $gallery->public_url }}" class="group bg-gray-800/60 border border-gray-700/50 rounded-xl overflow-hidden hover:border-purple-500 hover:-translate-y-1 transition-all duration-300">
                ...
                <div class="p-4">
                    <h3 class="text-gray-100 font-semibold group-hover:text-purple-300 transition-colors">{{ $gallery->title }}</h3>
    ...
    <p class="text-center mt-8">
        <a href="{{ route('discover') }}" class="text-purple-400 hover:text-purple-300 transition text-sm">Browse all 3D exhibitions →</a>
    </p>
</section>
