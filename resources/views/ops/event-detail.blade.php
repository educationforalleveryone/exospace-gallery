...
<div class="grid lg:grid-cols-3 gap-6">
    ...
    <div class="lg:col-span-2 space-y-6">
        ...
        <section class="rounded-lg border border-slate-800 bg-slate-900/40 p-5">
            <h2 class="text-xs font-bold uppercase tracking-wider text-emerald-400 mb-3">What happened</h2>
            @if($event->message)
        ...
        <section class="rounded-lg border border-slate-800 bg-slate-900/40 p-5">
            <h2 class="text-xs font-bold uppercase tracking-wider text-emerald-400 mb-3">Likely causes</h2>
            <ul class="space-y-2">
        ...
        <section class="rounded-lg border border-slate-800 bg-slate-900/40 p-5">
            <h2 class="text-xs font-bold uppercase tracking-wider text-emerald-400 mb-3">Related events on the same application</h2>
            ...
            <div class="divide-y divide-slate-800/70 rounded-lg border border-slate-800 overflow-hidden">
                @foreach($related as $rel)
                    <a href="{{ route('ops.events.show', $rel) }}" class="block p-3 hover:bg-slate-900/80 text-sm">
                        <span class="text-xs font-bold px-1.5 py-0.5 rounded mr-2 {{ $rel->severity === 'critical' ? 'bg-red-950/60 text-red-300' : ($rel->severity === 'error' ? 'bg-orange-950/50 text-orange-300' : 'bg-amber-950/50 text-amber-300') }}">{{ strtoupper($rel->severity) }}</span>
        ...
        <details class="rounded-lg border border-slate-800 bg-slate-900/40 p-5">
            <summary class="text-xs font-bold uppercase tracking-wider text-slate-500 cursor-pointer select-none">Technical context (already redacted)</summary>
            <div class="mt-4 space-y-4">
                <div>
                    <h3 class="text-xs uppercase tracking-wider text-slate-500 mb-1.5">Facts</h3>
    ...
    <div class="space-y-6">
        <section class="rounded-lg border border-slate-800 bg-slate-900/40 p-5">
            <h2 class="text-xs font-bold uppercase tracking-wider text-slate-500 mb-3">Where it happened</h2>
        ...
        <section class="rounded-lg border border-slate-800 bg-slate-900/40 p-5">
            <h2 class="text-xs font-bold uppercase tracking-wider text-slate-500 mb-3">How often</h2>
        ...
        <section class="rounded-lg border border-slate-800 bg-slate-900/40 p-5">
            <h2 class="text-xs font-bold uppercase tracking-wider text-slate-500 mb-3">What changed</h2>
            @php
