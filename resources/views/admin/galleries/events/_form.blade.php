    ...
    <div class="py-8 max-w-2xl mx-auto px-4">
        <form method="POST" action="@yield('form-action')">
            ...
            <div class="bg-gray-800 rounded-xl border border-gray-700 p-6 space-y-4">
                ...
                <div>
                    <label for="title" class="block text-sm font-medium text-gray-300 mb-1">Title <span class="text-red-400" aria-hidden="true">*</span></label>
                ...
                <div>
                    ...
                    <select id="type" name="type" class="w-full rounded-lg bg-gray-700 border-gray-600 text-gray-100 focus:border-purple-500 focus:ring-purple-500">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        <label for="starts_at" class="block text-sm font-medium text-gray-300 mb-1">Starts at <span class="text-red-400" aria-hidden="true">*</span></label>
                    ...
                    <div>
                        <label for="ends_at" class="block text-sm font-medium text-gray-300 mb-1">Ends at <span class="text-gray-500 text-xs">(optional)</span></label>
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        <label for="location_name" class="block text-sm font-medium text-gray-300 mb-1">Location name <span class="text-gray-500 text-xs">(optional)</span></label>
                    ...
                    <div>
                        <label for="location_url" class="block text-sm font-medium text-gray-300 mb-1">Location URL <span class="text-gray-500 text-xs">(optional)</span></label>
                ...
                <div>
                    <label for="capacity" class="block text-sm font-medium text-gray-300 mb-1">Capacity <span class="text-gray-500 text-xs">(blank = unlimited)</span></label>
