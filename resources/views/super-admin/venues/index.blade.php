    ...
    <div class="page-shell">
        ...
        <form method="GET" class="mb-5 flex flex-wrap items-center gap-3">
            <input type="text" name="q" value="{{ request('q') }}"
                   ...
                   class="rounded-lg bg-gray-800 border-gray-700 text-gray-100 px-3 py-2 text-sm w-64 focus:border-purple-500 focus:ring-purple-500">

            <select name="category" class="rounded-lg bg-gray-800 border-gray-700 text-gray-100 px-3 py-2 text-sm focus:border-purple-500 focus:ring-purple-500">
