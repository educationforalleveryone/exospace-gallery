...
<div class="bg-gray-800 rounded-xl border border-gray-700 p-6 mb-5">
    ...
    <div class="mt-4">
        ...
        <textarea name="description" rows="3" maxlength="1000"
                  class="input-base {{ $errors->has('description') ? 'input-error' : '' }}"
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4">
        <div>
            <label class="label-text mb-1.5">Category <span class="text-red-400">*</span></label>
            <select name="category" class="input-base {{ $errors->has('category') ? 'input-error' : '' }}">
        ...
        <div>
            <label class="label-text mb-1.5">Plan required <span class="text-red-400">*</span></label>
            <select name="plan_required" class="input-base">
        ...
        <div>
            ...
            <input type="text" name="version" value="{{ old('version', $venue->version ?? '1.0.0') }}"
                   placeholder="1.0.0"
                   class="input-base font-mono {{ $errors->has('version') ? 'input-error' : '' }}">
    ...
    <div class="mt-4">
        ...
        <textarea name="tags" rows="2"
                  class="input-base font-mono {{ $errors->has('tags') ? 'input-error' : '' }}"
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
        <div>
            ...
            <input type="number" name="capacity_min" value="{{ old('capacity_min', $venue->capacity_min) }}" min="1"
                   class="input-base {{ $errors->has('capacity_min') ? 'input-error' : '' }}" required>
        ...
        <div>
            ...
            <input type="number" name="capacity_max" value="{{ old('capacity_max', $venue->capacity_max) }}" min="1"
                   class="input-base {{ $errors->has('capacity_max') ? 'input-error' : '' }}">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div>
            ...
            <input type="file" name="thumbnail_image" accept="image/png,image/jpeg,image/webp"
                   class="file-base {{ $errors->has('thumbnail_image') ? 'input-error' : '' }}">
        ...
        <div>
            ...
            <input type="file" name="preview_model" accept=".glb,.gltf"
                   class="file-base {{ $errors->has('preview_model') ? 'input-error' : '' }}">
        ...
        <div>
            ...
            <input type="file" name="hdri_file" accept=".hdr,.exr"
                   class="file-base {{ $errors->has('hdri_file') ? 'input-error' : '' }}">
        ...
        <div>
            ...
            <input type="file" name="default_audio" accept=".mp3,.wav,.m4a"
                   class="file-base {{ $errors->has('default_audio') ? 'input-error' : '' }}">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div class="md:col-span-2">
            ...
            <textarea name="visual_config" rows="14"
                      class="input-base font-mono text-xs {{ $errors->has('visual_config') ? 'input-error' : '' }}"
        ...
        <div class="md:col-span-2">
            ...
            <textarea name="material_config" rows="10"
                      class="input-base font-mono text-xs {{ $errors->has('material_config') ? 'input-error' : '' }}"
    ...
    <div class="grid grid-cols-1 gap-4">
        <div>
            ...
            <textarea name="decorations" rows="8"
                      class="input-base font-mono text-xs {{ $errors->has('decorations') ? 'input-error' : '' }}"
        ...
        <div>
            ...
            <textarea name="lighting_fixtures" rows="8"
                      class="input-base font-mono text-xs {{ $errors->has('lighting_fixtures') ? 'input-error' : '' }}"
