...
@section('content')
    <div class="bg-gradient-to-br from-gray-900 via-brand-950/30 to-gray-900 border-b border-gray-800">
        <div class="max-w-page mx-auto px-4 py-16">
            <div class="text-center">
                <p class="text-brand-400 text-sm font-semibold tracking-widest uppercase mb-3">Artists</p>
    ...
    <div class="max-w-page mx-auto px-4 py-10">
                ...
                @foreach($artists as $artist)
                    <a href="{{ route('artist.profile', $artist->slug) }}" class="group bg-gray-800/60 border border-gray-700/50 rounded-xl overflow-hidden hover:border-brand-500 hover:-translate-y-1 hover:shadow-xl hover:shadow-brand-900/20 transition-all duration-300">
                        ...
                        <div class="p-3 flex items-center justify-between text-xs text-gray-500">
                            ...
                            <span class="text-brand-400 group-hover:text-brand-300 transition">View →</span>
                        </div>
                    </a>
                @endforeach
            </div>
        ...
        <nav class="mt-12 pt-8 border-t border-gray-800 flex flex-wrap gap-4 text-sm" aria-label="Discover more">
            ...
            <a href="{{ route('venues.index') }}" class="text-brand-400 hover:text-brand-300 transition">Browse venue templates</a>
        </nav>
    </div>
@endsection
