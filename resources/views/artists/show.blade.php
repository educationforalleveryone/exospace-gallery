    ...
    <div class="max-w-5xl mx-auto px-4 py-10">
        ...
        @if($galleries->isEmpty())
            <div class="text-center py-24">
                ...
                <p class="text-lg font-semibold text-gray-200 mb-2">No public artworks yet.</p>
                <p class="text-sm text-gray-500 max-w-md mx-auto">{{ $artist->name }} hasn't published any public exhibitions so far — new ones open regularly, so check back soon.</p>
            </div>
        @endif
