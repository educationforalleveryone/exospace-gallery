        ...
        return [
            ...
            [
                ...
                'visual_config' => [
                    ...
                    'structure_pass'          => 'rooms',
                    'placement'               => [
                        'density'          => 'intimate',   // salon-close rhythm
                        ...
                        'salon_rows'       => 2,            // the two-line salon hang
                        'upper_row_y'      => 2.98,         // upper hang centre (eye = 1.6)
                        // v3 "two rooms": the full-height curtain splits the
                        // salon into TWO hang rooms (receiving room at the
                        // spawn, gallery room at the hero wall). Six wall
                        // segments, both rooms filled at every count; the hero
                        // keeps a dead-centre slot on the front wall so the
                        // arrival reads it THROUGH the opening. keep_clear is
                        // superseded — the door keep lives in door_keep now.
                        'room_divider'     => ['at' => 0.5, 'opening' => 2.4, 'keep' => 0.55, 'door_keep' => 1.15, 'spacing' => 2.4],
                        'row_caps'         => [
                            ['maxWidth' => 2.0, 'maxHeight' => 1.45],   // eye line — large works (2.0: two 2.4-rhythm frames + borders never touch)
