...
class MfaController extends Controller
{
    ...
    public function setup(Request $request): View|RedirectResponse
    {
        ...
        try {
            // Use Google2FAQRCode (not the base Google2FA) because it
            // includes getQRCodeInline() which returns a base64 PNG
            // data URI — safe for CSP img-src 'self' data: blob:.
            // The base Google2FA::getQRCodeUrl() returns an otpauth://
            // URI which the CSP blocks when used as an <img src>.
            $google2fa = new \PragmaRX\Google2FAQRCode\Google2FA();
            $secret = $google2fa->generateSecretKey();

            // Generate QR code as inline base64 PNG data URI
