...
class VenueHonestyTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function test_seeded_descriptions_contains_no_known_overclaims(): void
    {
        ...
        $forbidden = [
            ...
            'partial dividers',             // no divider geometry exists
        ...
        $this->assertCount(12, $rows, 'Seeder must seed exactly the 12-venue catalog (including The Salon).');
    ...
    public function test_picker_query_excludes_draft_venues(): void
    {
        ...
        // The exact query the create/edit controllers use.
