...
class VenueDarkMuseumTest extends TestCase
{
    ...
    public function test_seeded_dark_museum_declares_the_deepened_identity(): void
    {
        ...
        $this->assertTrue($mc['texture_tint'] ?? false, '[dark-museum] texture_tint MUST be declared — without it the declared wall/floor colours never reach textured builds.');
