...
class VenueCyberSignalRoomTest extends TestCase
{
    ...
    public function test_the_copy_promise_matches_the_delivered_mechanic(): void
    {
        ...
        $this->assertMatchesRegularExpression('/neon/i', (string) $row->description, 'The rooms-pass contract (VenueRoomsTest) pins the neon promise.');
        $this->assertMatchesRegularExpression('/floor/i', (string) $row->description, 'The rooms-pass contract (VenueRoomsTest) pins the floor light promise.');
    }
